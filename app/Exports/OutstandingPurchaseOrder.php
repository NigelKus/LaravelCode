...
class OutstandingPurchaseOrder implements FromCollection, WithHeadings, WithStyles
{
    ...
    public function collection()
    {
        ...
        foreach ($this->purchaseOrder as $order) {
            $data->push([
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $lastRow = count($this->purchaseOrder) + 4; // Adjust for headings and empty rows
