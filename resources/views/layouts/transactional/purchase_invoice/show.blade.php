            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">{{ \Carbon\Carbon::parse($purchaseInvoice->date)->format('Y-m-d H:i') }}</dd>
            
                        <dt class="col-sm-3">Due Date</dt>
                        <dd class="col-sm-9">{{ \Carbon\Carbon::parse($purchaseInvoice->due_date)->format('Y-m-d H:i') }}</dd>
