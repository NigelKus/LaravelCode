        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('sales_invoice.update', $salesInvoice->id) }}" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ old('date', $salesInvoice->date->format('Y-m-d\TH:i')) }}">
                    @error('date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control @error('due_date') is-invalid @enderror" id="due_date" name="due_date" value="{{ old('due_date', $salesInvoice->due_date->format('Y-m-d\TH:i')) }}">
                    @error('due_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
